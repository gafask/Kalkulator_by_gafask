...
namespace test
	 ...
	 /// <summary>
	 /// Сводка для CalculationMainForm
	 /// </summary>
	 public ref class CalculationMainForm : public System::Windows::Forms::Form
		  {
			   public:
			   CalculationMainForm ( void )
					{
					InitializeComponent ( );
					//
...
#pragma region Windows Form Designer generated code
		...
		/// </summary>
			   void InitializeComponent ( void )
					{
				   System::ComponentModel::ComponentResourceManager^ resources = ( gcnew System::ComponentModel::ComponentResourceManager ( CalculationMainForm::typeid ) );
				   ...
				   this->Ymnogit->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Ymnogit_Click );
				   // 
				   // Rasdelit
				   // 
				   ...
				   this->Rasdelit->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Rasdelit_Click );
				   // 
				   // Minys
				   // 
				   ...
				   this->Minys->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Minys_Click );
				   // 
				   // Plus
				   // 
				   ...
				   this->Plus->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Plus_Click );
				   // 
				   // Nol
				   // 
				   ...
				   this->Nol->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Nol_Click );
				   // 
				   // Otvet
				   // 
				   ...
				   this->Otvet->TextChanged += gcnew System::EventHandler ( this, &CalculationMainForm::Otvet_TextChanged );
				   // 
				   // Devat
				   // 
				   ...
				   this->Devat->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Devat_Click );
				   // 
				   // Vosem
				   // 
				   ...
				   this->Vosem->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Vosem_Click );
				   // 
				   // Sem
				   // 
				   ...
				   this->Sem->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Sem_Click );
				   // 
				   // Shest
				   // 
				   ...
				   this->Shest->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Shest_Click );
				   // 
				   // Piat
				   // 
				   ...
				   this->Piat->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Piat_Click );
				   // 
				   // Chetiri
				   // 
				   ...
				   this->Chetiri->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Chetiri_Click );
				   // 
				   // Tri
				   // 
				   ...
				   this->Tri->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Tri_Click );
				   // 
				   // Dva
				   // 
				   ...
				   this->Dva->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Dva_Click );
				   // 
				   // Ravno
				   // 
				   ...
				   this->Ravno->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Ravno_Click );
				   // 
				   // Primer1
				   // 
				   ...
				   this->Steret1->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Steret_Click );
				   // 
				   // Deistvie
				   // 
				   ...
				   this->Steret2->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Steret2_Click );
				   // 
				   // Steret3
				   // 
				   ...
				   this->Steret3->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Steret3_Click );
				   // 
				   // pictureBox1
				   // 
				   ...
				   this->Odin->Click += gcnew System::EventHandler ( this, &CalculationMainForm::Odin_Click );
				   // 
				   // CalculationMainForm
				   // 
				   ...
				   this->Name = L"CalculationMainForm";
...
#pragma endregion
	...
	private: System::Void Otvet_TextChanged ( System::Object^ sender, System::EventArgs^ e )
		{ }
};
	 }
